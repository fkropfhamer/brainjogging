...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          HomeCard(text: "Training", target: TrainingList()),
          HomeCard(text: "Time Training", target: TimeTraining()),
          HomeCard(text: "Random Challenge", target: RandomChallenge()),
          HomeCard(text: "Challenge", target: TimedChallenge()),
          HomeCard(text: "Time Challenge", target: TimeChallenge()),
        ],
      ),
    );
  }
